...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "STARK-ALI~HsAiWDAJ#YzvICTfUPBB9h2VqPa32gzJ8Wua5BMMp_EB78dI-n_c",
// add your Session Id 
...
// make true if you want auto reply on status 
AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || "*SEEN YOUR STATUS JUST NOW RIJU_XMD👻*",
// set the auto reply massage on status reply  
PREFIX: process.env.PREFIX || ".",
// add your prifix for bot   
BOT_NAME: process.env.BOT_NAME || "RIJU_XMD",
// add bot namw here for menu
STICKER_NAME: process.env.STICKER_NAME || "RIJU",
...
OWNER_NUMBER: process.env.OWNER_NUMBER || "919332446037",
